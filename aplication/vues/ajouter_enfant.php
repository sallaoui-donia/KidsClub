...
<div id="centhh">
<h4 class="h4">AJOUTER ENFANT : </h4> 
			
			 
			<form name="form1" method="post" action="../model/add_enfant.php" onSubmit="return verif();">
                	<label>Nom de votre enfant</label>
			<input name="nom_prenom" type="text" class="input_ins" id="nom_prenom" placeholder="Nom" required>
 		  	<br>
			...
			<input name="Classe" type="text" class="input_ins" id="Classe" placeholder="Quelle Classe votre enfant" required>
			<br><label>Date de naissance</label>
			<input name="daten" type="date" required class="input_date" id="date_debut_hackaton" placeholder="Date de Naissance">
			<br>
