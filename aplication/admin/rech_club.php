...
<div id="mainadmin">
	...
	<div>
			<h1 class="h4">Demandes De Gérants</h1> 
			  ...
			  <tr class="table">
				...
				<td width="17%">Action</td>
				 ...
				 <?php
								...
								$result = $connexion->prepare("SELECT * FROM club WHERE nom like \"%$recherch%\" LIMIT $start_from, 10");
								$result->execute();
			...
			<td><?php echo $row['idC']; ?></td>
				...
				<td><img src="../../<?php echo $row['image']; ?>"  style="width:180px; height:90px;"/></td>
                  ...
                  <td><a href="valid_club.php?id=<?php echo $row['idC']; ?>"><img src="../../system/images/valider.png" width="26" height="26"></a></td><?php } ?>
			  </tr>
