...
<h4 class="h4">Entre nom de club et valider les candidatures</h4> 
	   <form name="form1" method="post" action="list_candidatures_etud.php">
	 
	    <input name="titre" type="text" class="iupt_rechr" id="titre" size="40" placeholder="Entre le nom de club" >
