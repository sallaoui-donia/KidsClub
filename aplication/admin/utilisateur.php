...
<div id="mainadmin">
	...
	<div>
			...
			<h4 class="h4">Liste de Parents</h4> 
			<a class="btn_ajout" href="ajouter_utilisateur.php"  style="text-decoration:none;">Ajouter</a>
			...
			<table width="95%" border="0" align="center" class="table">
			  <tr class="table">
				...
				<td width="17%">Action</td>
				 <?php
								...
								$start_from = ($page-1) * 3;
								$result = $connexion->prepare("SELECT * FROM personne WHERE id_statut=3 LIMIT $start_from, 2");
								$result->execute();
			  ...
			  <tr>
				...
				<td><a href="mod_util.php?id=<?php echo $row['id']; ?>"onClick="return confirm('Vous pouvez modifier ..!');"><img src="../../system/images/modifier.JPG"></a>
			...
			<div id="centh" style="height:450px;">
			<h4 class="h4">List des Gérants </h4> 
			<a class="btn_ajout" href="ajouter_utilisateur.php" style="text-decoration:none;">Ajouter</a>
			...
			<table width="95%" border="0" align="center" class="table">
			  <tr class="table">
				...
				<td width="20%">Action</td>
				 <?php
								...
								if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; };
								$start_from = ($page-1) * 3;
								$result = $connexion->prepare("SELECT * FROM personne WHERE id_statut=2 LIMIT $start_from, 2");
								$result->execute();
								for($i=0; $row = $result->fetch(); $i++){
								$id=$row['id'];
				?>
			  ...
			  <tr>
				...
				<td><?php echo $row['dateN']; ?></td>
                  ...
                  <td><?php echo $row['pasword']; ?></td>
				<td>
				<a href="mod_util.php?id=<?php echo $row['id']; ?>"onClick="return confirm('Vous pouvez modifier ..!');"><img src="../../system/images/modifier.JPG"></a>
				<a  href="../model/sup_user.php?id=<?php echo $row['id']; ?>" onClick="return confirm('attention cette operation ne peut pas etre recuperer');">
